...
const {api: k8sApi} = require('./kubernetes');

const versionController = require('./controllers/version');
const clustersController = require('./controllers/clusters');
...
publicRouter.post('/clusters', clustersController.create);
publicRouter.get('/clusters', clustersController.list);
publicRouter.get('/clusters/:uid', clustersController.get);
publicRouter.patch('/clusters/:uid', clustersController.patch);
publicRouter.get('/clusters/:uid/metrics', clustersController.metrics);
publicRouter.delete('/clusters/:uid', clustersController.delete);
